...
const navigate = useNavigate()
  ...
  return (
    ...
    bg-[url('/backgroundImage.png')] bg-cover bg-center h-screen">
        ...
        <p className="max-w-md text-grat-300">In a post-apocalyptic world where cities ride on wheels and consume each other to survive, two people meet in London and try to stop a conspiracy.</p>
